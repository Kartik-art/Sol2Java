...
class Conditional(Node):
    ...
    def __init__(self, node_info, _previous = None, _is_cfg_node = True):
        ...
        for child in children:
            ...
            #print("checking conditional ", child_node.get_java_equivalent_code())
            childnode_list.append(child_node.get_java_equivalent_code())
            self.__imf_repr.append(child_node.get_imf())
            
        self.convert_to_java(childnode_list)
        
        print(self.__argument_types)
        print(self.__is_constant)
        print(self.__is__lValue)
        print(self.__is_pure)
        print(self.__is_lValue_requested)
        print(self.__type)
        
    def convert_to_java(self, childnode_list):
        
        java_code = childnode_list[0] + " ? " + childnode_list[1] + " : " + childnode_list[2] 
