...
from src.bl.abi.encoder import Encoder
kivy.require('1.10.1')
...
from src.bl.opcode.instruction_processor import InstructionProcessor
from src.bl.manager.transaction import Transaction
from src.bl.manager.contract import ContractManager as scm

from src.bl.memory.ethereum_machine import EthereumStateMachine
    ...
    def compile_code(self, source_code, version):
        ...
        if self.select_solidity_compiler(version):
            ...
            try:
                ...
                #print("AST:", self.sc_manager.helper.get_ast())
                #input()
                    #print("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
                #print(cfg_builder.get_functions_info())
